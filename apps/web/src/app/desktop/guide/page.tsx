  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
        ...
        {/* Main Content */}
        <div className="flex-1 min-w-0 p-4 sm:p-6 lg:pl-0 max-w-4xl mx-auto lg:mx-0">
          {/* Header */}
          <section className="relative overflow-hidden pt-16 sm:py-20">
            <div className="text-center mb-16">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-tight">
              ...
              <Link href="#getting-started" className="block">
                <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer bg-white/80 backdrop-blur-sm border border-white/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-base sm:text-md flex items-center gap-2 leading-tight">
                      <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                        <Rocket className="w-4 h-4 text-white" />
                      </div>
                      <span className="min-w-0">はじめに</span>
                    </CardTitle>
                    <CardDescription className="text-sm">基本的な使い方</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
                ...
                <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer bg-white/80 backdrop-blur-sm border border-white/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-base sm:text-md flex items-center gap-2 leading-tight">
                      ...
                      <span className="min-w-0">機能</span>
                    </CardTitle>
                    <CardDescription className="text-sm">主要な4つの機能</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
                ...
                <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer bg-white/80 backdrop-blur-sm border border-white/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-base sm:text-md flex items-center gap-2 leading-tight">
                      ...
                      <span className="min-w-0">ショートカット</span>
                    </CardTitle>
                    <CardDescription className="text-sm">便利なキー操作</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
                ...
                <Card className="h-full hover:shadow-lg transition-all duration-300 cursor-pointer bg-white/80 backdrop-blur-sm border border-white/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-base sm:text-md flex items-center gap-2 leading-tight">
                      ...
                      <span className="min-w-0">問題解決</span>
                    </CardTitle>
                    <CardDescription className="text-sm">よくある問題と対処法</CardDescription>
                  </CardHeader>
                </Card>
              </Link>
            </div>
          ...
          {/* Getting Started */}
          <section id="getting-started" className="py-12 border-b border-slate-200/50">
          ...
          {/* Features */}
          <section id="features" className="py-12 border-b border-slate-200/50">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-slate-900 flex items-center gap-3">
            ...
            <div className="space-y-16">
              <div id="save-prompts" className="pt-8 border-t border-slate-200/30">
              ...
              <div id="search-prompts" className="pt-8 border-t border-slate-200/30">
              ...
              <div id="use-prompts" className="pt-8 border-t border-slate-200/30">
                  ...
                  <div>
                    ...
                    <div className="bg-slate-50 rounded-lg p-4">
                      <div className="space-y-2 text-sm text-slate-600">
                        <div>
                          • プロンプトを選択して{' '}
                          <kbd className="bg-slate-100 px-2 py-1 rounded text-xs">Enter</kbd>{' '}
                          でコピー
                        </div>
              ...
              <div id="palette-favorites" className="pt-8 border-t border-slate-200/30">
          ...
          {/* Keyboard Shortcuts */}
          <section id="keyboard-shortcuts" className="py-12 border-b border-slate-200/50">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-slate-900 flex items-center gap-3">
          ...
          {/* Troubleshooting */}
          <section id="troubleshooting" className="py-12 border-b border-slate-200/50">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-slate-900 flex items-center gap-3">
